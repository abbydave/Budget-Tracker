...
const ProfilePage = () => {
  ...
  if (error) {
    return (
      <div className="p-6 text-red-500 bg-red-500/10 rounded-lg">{error}</div>
    );
  }
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-6 bg-white/5 backdrop-blur-md border border-white/10 shadow-2xl w-full md:w-100 p-6 mt-6 rounded-lg">
        <Image
          src={profilePicture}
          alt="Profile Picture"
          width={100}
        ...
        <div className="flex flex-col">
          ...
          <button className="bg-linear-to-r from-[#7C3AED] to-[#6D28D9] text-white px-4 py-2 rounded-lg mt-4 w-fit text-sm">
            Pro Member
          </button>
        </div>
      </div>
